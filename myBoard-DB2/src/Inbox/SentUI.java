...
public class SentUI extends InboxBaseUI {

	@Override
	public void execute() throws Exception {

		List<InboxVO> list = inboxservice.searchInbox();

		if (list.isEmpty()) {
			System.out.println("보낸 메일이 없는데유?!?!?!");
			new MailMenu().execute();
		}

		else {
			System.out.println("=======================================================================================");
			System.out.println("                   " + MemberVO.loginVO.getName() + "님께서 보낸 메일임당~!");
			System.out.println("=======================================================================================");
